...
import 'package:sugar_pros/ui/views/auth/login/patient_login/patient_login_viewmodel.dart';

class PatientLoginView extends StackedView<PatientLoginViewModel> {
  const PatientLoginView({super.key});

  @override
  Widget builder(BuildContext context, PatientLoginViewModel viewModel, Widget? child) {
    return Scaffold(
      body: SafeArea(
        child: Padding(
  ...
  @override
  PatientLoginViewModel viewModelBuilder(BuildContext context) => PatientLoginViewModel();
}
