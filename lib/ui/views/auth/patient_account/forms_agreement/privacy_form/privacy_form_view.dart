...
import 'package:sugar_pros/ui/views/auth/patient_account/forms_agreement/privacy_form/privacy_form_viewmodel.dart';
...
class PrivacyForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<PrivacyFormViewmodel>.reactive(
      viewModelBuilder: () => PrivacyFormViewmodel(),
      builder:
                        ...
                        children: [
                          ...
                          Text.rich(
                            TextSpan(
                              children: [
                                TextSpan(
                                  text: 'This Notice was originally published and effective on ',
                                  style: BrandTextStyles.regular.copyWith(
                                    fontSize: 14.sp,
                                    color: hexColor('#4E4E50'),
                                  ),
                         ...
                         DatePickerfield(
                          ...
                          CustomTextField(
                            ...
                            maxLines: 4,
                            controller: viewModel.userMessageCtrl,
                          ),
                          20.verticalSpace,
                          Text(
                          ...
                          Row(
                            ...
                            children: [
                              InkWell(
                                onTap: () => viewModel.toggleAggrement1(),
                                child: Container(
                                  width: 19.w,
                                  height: 19.w,
                          ...
                          Row(
                            ...
                            children: [
                              InkWell(
                                onTap: () => viewModel.toggleAggrement2(),
                                child: Container(
                                  width: 19.w,
                                  height: 19.w,
                                  margin: EdgeInsets.only(top: 4.h),
                                ...
                                child: Text.rich(
                                  TextSpan(
                                    children: [
                                      ...
                                      TextSpan(
                                        text: 'Notice of Privacy Practices on behalf of',
                                        style: BrandTextStyles.regular.copyWith(
                                          fontSize: 14.sp,
                                          color: hexColor('#4E4E50'),
                                        ),
                          ...
                          CustomTextField(
                            ...
                            controller: viewModel.repNameCtrl,
                          ),
                          25.verticalSpace,
                         DatePickerfield(
                            label: 'Date',
                            ...
                            placeholder: 'MM/DD/YYYY',
                            controller: viewModel.serveiceDateCtrl,
                            initialDate: DateTime.now(),
                            startDate: DateTime.now(),
                            stopDate: DateTime(2053),
                            onDateSelected: (value) => viewModel.serviceDate = value,
                          ),
                          25.verticalSpace,
                          CustomTextField(
                            label:
                    ...
                    children: [
                      Expanded(
                        child: CustomButton(
                          onTap: () {
                            log('message');
                            viewModel.navigateToCompliance();
                          },
                          title: 'Next',
                        ),
                      ),
