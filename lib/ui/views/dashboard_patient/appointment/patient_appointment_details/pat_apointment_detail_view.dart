...
import 'package:sugar_pros/ui/views/dashboard_patient/appointment/patient_appointment_details/pat_appointment_detail_viewmodel.dart';
import 'package:sugar_pros/ui/widgets/svg_icon.dart';

class PatAppointmentDetailView extends StackedView<PatAppointmentDetailViewModel> {
  const PatAppointmentDetailView({super.key, required this.app});

  final PatientAppointments app;

  @override
  Widget builder(BuildContext context, PatAppointmentDetailViewModel viewModel, Widget? child) {
    return Scaffold(
  ...
  @override
  PatAppointmentDetailViewModel viewModelBuilder(BuildContext context) =>
      PatAppointmentDetailViewModel();
}
