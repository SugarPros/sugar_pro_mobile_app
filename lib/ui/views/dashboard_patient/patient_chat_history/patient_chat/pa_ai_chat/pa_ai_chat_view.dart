...
import 'package:sugar_pros/ui/views/dashboard_patient/patient_chat_history/patient_chat/pa_ai_chat/pa_ai_chat_viewmodel.dart';
import 'package:sugar_pros/ui/widgets/svg_icon.dart';

class PaAiChatView extends StatefulWidget {
  const PaAiChatView({super.key, required this.chatId});

  final String? chatId;

  @override
  State<PaAiChatView> createState() => _PaAiChatViewState();
}

class _PaAiChatViewState extends State<PaAiChatView> {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<PaAiChatViewModel>.reactive(
      viewModelBuilder: () => PaAiChatViewModel(),
      onViewModelReady: (viewModel) {
        viewModel.setup(widget.chatId);
      },
      builder:
