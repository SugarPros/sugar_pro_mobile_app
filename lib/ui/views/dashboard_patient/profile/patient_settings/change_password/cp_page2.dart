...
class CpPage2 extends StatelessWidget {
  const CpPage2({super.key});
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CustomTextField(
                              ...
                              suffixFunc:
                                  () => viewModel.obscureCurrentPassword = !viewModel.obscureCurrentPassword,
                            ),
                            25.verticalSpace,
                            CustomTextField(
                            ...
                            CustomTextField(
                              ...
                              suffixFunc:
                                  () => viewModel.obscureConfirmPassword = !viewModel.obscureConfirmPassword,
                            ),
                            ...
                            CustomButton(
                              onTap: () {
                                ...
                                if (formKey.currentState!.validate()) {
                                  ...
                                  if (viewModel.currentPasswordCtrl.text == viewModel.newPasswordCtrl.text) {
                                    flusher(
                                      'Current password can not be same as new password',
                                      color: Colors.red,
                                    );
                                    return;
                                  }
                                  if (viewModel.newPasswordCtrl.text != viewModel.confirmPasswordCtrl.text) {
                                    flusher('Passwords do not match', color: Colors.red);
                                    return;
                                  }
