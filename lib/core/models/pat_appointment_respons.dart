class PatAppointmentResponse {
  String? type;
  List<PatientAppointments>? patAppointments;

  PatAppointmentResponse({this.type, this.patAppointments});

  PatAppointmentResponse.fromJson(Map<String, dynamic> json) {
    type = json['type'];
    if (json['appointments'] != null) {
      patAppointments = <PatientAppointments>[];
      json['appointments'].forEach((v) {
        patAppointments!.add(PatientAppointments.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['type'] = type;
    if (patAppointments != null) {
      data['appointments'] = patAppointments!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
